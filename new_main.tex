...
features as input to a meta-classifier. Explainability work could extend
SHAP/LIME analyses to identify which clinical phrases most drive each
BI-RADS prediction, while temporal validation could evaluate robustness
